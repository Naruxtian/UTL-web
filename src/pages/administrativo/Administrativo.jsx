...
const Administrativo = () => {
    ...
    const sections = {
        ...
        Desarrollo: (
            <div> <br /> <br />
                <div className='Aspirante'>
                    <h1><a href="https://sito.utleon.edu.mx/jsp/reclutamiento/muestra_convocatoria_general.jsp" target='_blank'>Reclutamiento y Selección</a></h1>
                </div> <br /> <br />
                <div className='Aspirante'>
                <h1>Capacitación</h1>
                    <div className='div-modeloEducativo'>
                            ...
                            <table className='table'>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <th>Identifica la estructura básica de la accesibilidad web, partiendo de la necesidad de elaborar un diseño universal que permita a las personas con discapacidad el acceso a la información en condiciones de igualdad y sin discriminación.</th>
                                        <th rowSpan={4} style={{ verticalAlign: 'middle', textAlign: 'center' }}>Desarrollo de habilidades</th>
                                        <th rowSpan={4} style={{ verticalAlign: 'middle', textAlign: 'center' }}>Interno</th>
                                        <th rowSpan={4} style={{ verticalAlign: 'middle', textAlign: 'center' }}>Acreditar a las personas servidoras públicas en temas que impactan en su desarrollo profesional y personal</th>
                                        <th rowSpan={4} style={{ verticalAlign: 'middle', textAlign: 'center' }}>Febrero - Noviembre 2022</th>
                                    </tr>
                                    <tr>
                                        <th>Administración de proyectos</th>
                                        <th>Conoce e identifica cada una de las etapas de la metodología PMI® para aplicar las mejores prácticas internacionales en la administración eficiente de proyectos.</th>
                                    </tr>
                                    <tr>
                                        <th>Claves para la atención pública sin discriminación</th>
                                        <th>Identifica estrategias que permiten a las servidoras públicas y a los servidores públicos encaminar su actuar hacia un trato libre de discriminación en el contexto mexicano.</th>
                                    </tr>
                                    <tr>
                                        <th>Cómo gestionar tu tiempo de forma fácil y sencilla</th>
                                        <th>Desarrolla habilidades para la dirección y administración del tiempo aplicando técnicas y herramientas para su gestión con el objetivo de cumplir las metas establecidas y mejorar la eficiencia en el trabajo.</th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
  ...
  return (
    <div>
        ...
        <div className="section-buttons">
          ...
          <button className='btn' onClick={() => handleSectionChange('Transparencia')}>Transparencia</button>
          <button className='btn' onClick={() => handleSectionChange('Salud')}>Salud Integral</button>
          <button className='btn' onClick={() => handleSectionChange('Seguridad')}>Seguridad Institucional</button>
        </div>
