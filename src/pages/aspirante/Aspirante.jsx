      ...
      Conocenos: (
          ...
          <div className='Aspirante'>
            ...
            <div className="div-historia">
              <div className='div-historia-izq col-5'>
                <img src="/src/assets/img/universidad.png" alt="Imagen" className="image" />
              </div>
        ...
        <div className='Aspirante'>
          ...
          <div className='div-modeloEducativo-izq col-7'>
              <p>La Universidad Tecnológica de León (UTL) forma parte del Sistema Nacional de Universidades Tecnológicas, integrado por más de 122 planteles en la República Mexicana. Nuestro modelo ofrece planes de estudio funcionales, para formar a los profesionales que requieren los sectores productivos y sociales.
                La UTL cuenta con mas de 27 años de experiencia y ha recibido importantes reconocimientos de calidad. Tenemos las certificaciones en la norma ISO 9001:2015 e ISO 14001:2015, NMX-R-025-SCFI-2015, además de todos nuestros programas educativos están acreditados en calidad por organismos reconocidos por el COPAES (Consejo para la Acreditación de la Educación Superior) y CIEES (Comités Interinstitucionales para la Evaluacion de la Educacion Superior).</p>
            </div>
        ...
        <div className='Aspirante'>
          ...
          <div className='div-becas'>
            <div className='col-7'>
              <p><b>La Universidad Tecnológica de León,</b>cuenta con un sistema de Becas Internas y Externas con el objetivo de brindar apoyo para que el alumnado pueda continuar con su preparación académica y aminorar los factores económicos.
                  ¡Que las cuestiones financieras no sean una limitante para que puedas continuar con tus estudios!</p>
            </div>
            <div className='div-becas-der col-5'>
              <img src="/src/assets/img/becas.jpg" alt="" />
            </div>
          </div>
          <div><div><iframe title="Sitio Becas_EA5" frameborder="0" width="800px" height="1600px"  src="https://view.genial.ly/63ed23b4958690001992bfc8" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe> </div> </div>
        </div> <br /> <br />
        <div className='Aspirante'>
          <h1>Ubicaciones</h1>
      ...
      Admisiones: (
        <div> <br /> <br />
          ...
          <h1>Admisiones TSU</h1>
            <div className='row'><div><iframe title="Proceso de admisión TSU 2023" frameborder="0" width="1000px" height="675px"  src="https://view.genial.ly/61ddab3ca31fbb0d87451c9b" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe> </div> </div>
          </div> <br /> <br />
          <div className='Aspirante'>
  ...
  return (
    <div>
        ...
        <div className="section-buttons">
          <button className='btn ' onClick={() => handleSectionChange('Conocenos')}>Conócenos</button>
