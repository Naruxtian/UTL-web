...
const Empresario = () => {
    ...
    <div className="col-4">
      <div className="card custom-card">
        ...
        <div className="card-body">
          ...
          <a href="Carrera.jsx" className="btn btn-primary">Leer más</a>
        </div>
      </div>
    </div>
  );
  ...
  const cardsData = [
    { title: 'TSU EN TI ÁREA ENTORNOS VIRTUALES Y NEGOCIOS DIGITALES', imageSrc: '/src/assets/img/carrerasTSU/EntornosVirtualesYNegociosDigitales.jpg' },
    { title: 'TSU EN TI ÁREA DESARROLLO DE SOFTWARE MULTIPLATAFORMA', imageSrc: '/src/assets/img/carrerasTSU/DesarrolloDeSoftwareMultiplataforma.jpg' },
    { title: 'TSU EN TI ÁREA INFRAESTRUCTURA DE REDES DIGITALES', imageSrc: '/src/assets/img/carrerasTSU/RedesYTelecomunicaciones.jpg' },
    { title: 'TSU EN ADMINISTRACIÓN ÁREA CAPITAL HUMANO', imageSrc: '/src/assets/img/carrerasTSU/administracion.jpg' },
    { title: 'TSU EN DESARROLLO DE NEGOCIOS ÁREA MERCADOTECNIA', imageSrc: '/src/assets/img/carrerasTSU/DesarrolloDeNegociosAreaMercadotecnia.jpg' },
    { title: 'TSU EN TURISMO ÁREA HOTELERÍA', imageSrc: '/src/assets/img/carrerasTSU/Turismo.jpg' },
    { title: 'TSU EN GASTRONOMÍA', imageSrc: '/src/assets/img/carrerasTSU/Gastronomía.jpg' },
    { title: 'LOGÍSTICA ÁREA TRANSPORTE TERRESTRE', imageSrc: '/src/assets/img/carrerasTSU/TransporteTerrestre.jpg' },
    { title: 'TSU EN QUÍMICA ÁREA TECNOLOGÍA AMBIENTAL', imageSrc: '/src/assets/img/carrerasTSU/Química.jpg' },
    { title: 'TSU EN MECATRÓNICA ÁREA SISTEMAS DE MANUFACTURA FLEXIBLE', imageSrc: '/src/assets/img/carrerasTSU/Manufactura.jpg' },
    { title: 'TSU EN MECATRÓNICA ÁREA OPTOMECATRÓNICA', imageSrc: '/src/assets/img/carrerasTSU/Mecatrónica.jpg' },
    { title: 'TSU EN PROCESOS INDUSTRIALES ÁREA AUTOMOTRIZ', imageSrc: '/src/assets/img/carrerasTSU/Automotriz.jpg' },
    { title: 'TSU EN PROCESOS INDUSTRIALES ÁREA MANUFACTURA', imageSrc: '/src/assets/img/carrerasTSU/Manufactura.jpg' },
    { title: 'TSU EN PROCESOS INDUSTRIALES ÁREA PLÁSTICOS', imageSrc: '/src/assets/img/carrerasTSU/Plásticos.jpg' },
    { title: 'TSU EN PROCESOS INDUSTRIALES ÁREA GESTIÓN Y PRODUCTIVIDAD DE CALZADO', imageSrc: '/src/assets/img/carrerasTSU/GestiónYProductividadDeCalzado.jpg' },
    { title: 'TSU EN MANTENIMIENTO ÁREA INDUSTRIAL', imageSrc: '/src/assets/img/carrerasTSU/MantenimientoIndustrial.jpg' },
  ];

  const cardDataIng = [
    { title: 'INGENIERÍA EN ENTORNOS VIRTUALES Y NEGOCIOS DIGITALES', imageSrc: '/src/assets/img/carrerasING/EntornosVirtualesYNegociosDigitales.jpg' },
    { title: 'INGENIERÍA EN DESARROLLO Y GESTIÓN DE SOFTWARE', imageSrc: '/src/assets/img/carrerasING/GestiónDeSoftware.jpg' },
    { title: 'INGENIERÍA EN REDES INTELIGENTES Y CIBERSEGURIDAD', imageSrc: '/src/assets/img/carrerasING/RedesInteligentesYCiberseguridad.jpg' },
    { title: 'LICENCIATURA EN GESTIÓN DEL CAPITAL HUMANO', imageSrc: '/src/assets/img/carrerasING/CapitalHumano.jpg' },
    { title: 'LICENCIATURA EN INNOVACIÓN DE NEGOCIOS Y MERCADOTECNIA', imageSrc: '/src/assets/img/carrerasING/InnovaciónDeNegociosYMercadotecnia.jpg' },
    { title: 'LICENCIATURA EN GESTIÓN Y DESARROLLO TURÍSTICO', imageSrc: '/src/assets/img/carrerasING/DesarrolloTurístico.jpg' },
    { title: 'LICENCIATURA EN GASTRONOMÍA', imageSrc: '/src/assets/img/carrerasING/Gastronomía.jpg' },
    { title: 'LICENCIATURA EN DISEÑO Y GESTIÓN DE REDES LOGÍSTICAS', imageSrc: '/src/assets/img/carrerasING/RedesLogísticas.jpg' },
    { title: 'INGENIERÍA EN TECNOLOGÍA AMBIENTAL', imageSrc: '/src/assets/img/carrerasING/TecnologíaAmbiental.jpg' },
    { title: 'INGENIERÍA EN MECATRÓNICA', imageSrc: '/src/assets/img/carrerasING/Mecatrónica.jpg' },
    { title: 'INGENIERÍA EN MANTENIMIENTO INDUSTRIAL', imageSrc: '/src/assets/img/carrerasING/MantenimientoIndustrial.jpg' },
    { title: 'INGENIERÍA EN SISTEMAS PRODUCTIVOS', imageSrc: '/src/assets/img/carrerasING/SistemasProductivos.jpg' },
  ];
    ...
    const sections = {
                    ...
                    <h1>Filosofía</h1>
                        ...
                        <div className='div-filosofiamvv col-6'>
                            ...
                            {valores.map((valor, index) => (
                                ...
                                <button
                                    className={`btn valor-button ${activeValue === index ? 'active' : ''}`}
                    ...
                    <h3>Plan Institucional de Desarrollo 2015-2020 (PIDE)</h3>
                        <div class="cards">
                            ...
                            <div class="card-body">
                                ...
                                <p><b>Objetivo general:</b>Garantizar la calidad educativa.</p>
                            </div>
                        </div> <br />
                        <div class="cards">
                            <div style={headerStyle} class="card-header text-white w-100">
                            ...
                            <div class="card-body">
                                <p>La investigación aplicada y la innovación son pilares fundamentales de nuestra Universidad, estamos comprometidos con la construcción y trasferencia de conocimientos que mejoren la calidad de vida de las personas.</p>
                                <p><b>Objetivo general:</b>Generar nuevo conocimiento que contribuya a la solución de problemas de manera innovadora , que mejore la calidad de vida de las personas y genere riqueza.</p>
                            </div>
                        </div> <br />
                        <div class="cards">
                            <div style={headerStyle} class="card-header text-white w-100">
        ...
        OfertaEducativa: (
          <div> <br /> <br />
            ...
            <div className='div-ofertaEducativa'>
              <div className='row'>
                  ...
                  <h1>Estadias Empresariales</h1>
                      <div className='div-modeloEducativo'>
                          <div className='div-modeloEducativo-izq col-7'>
                              <p>La Estadía es la práctica profesional de Técnico/a Superior Universitario/a (TSU) o de nivel Licenciatura o Ingeniería donde el estudiante desarrolla un proyecto real del área relacionada con la carrera que cursa.</p>
                              <p>Dicha estadía se desarrolla en un periodo de 13 semanas.</p>
                              <ul>
                                  <li>El estudiante es guiado por un/a Asesor/a Académico/a (docente de tiempo completo y experto en el área) y un/a Asesor/a Organizacional (persona designada por la organización para el seguimiento del proyecto).</li>
                                  <li>Se le debe proporcionar al estudiantado el espacio, material y equipo necesario para desarrollar el proyecto.</li>
                  ...
                  <h1>¿Qué es un Analisis Situacional del Trabajo (AST)?</h1>
                      <div className='div-modeloEducativo'>
                          <div className='div-modeloEducativo-izq col'>
                              <p>Es una sesión de grupo donde se pretende identificar los: requerimientos y expectativas reales de una empresa o sector productivo.</p>
                              <h3>Objetivo</h3>
                              <ul>
                                  <li>Identificar las habilidades y características pertinentes con las que debe contar el recién egresado: “necesidades presentes y de futuro inmediato”</li>
                                  <li>Conocer el campo laboral y ordenar las funciones productivas, de modo tal, que se llegue a una descripción precisa de un área ocupacional.</li>
                                  <li>Actualización de planes de estudio y servicios de capacitación, el cual por reglamento deberá ser cada 3 años.</li>
                              </ul>
          ...
          <div className='Aspirante'>
            ...
            <div className='Aspirante'>
                  <h1>CENTRO DE INNOVACIÓN Y DESARROLLO EN TI (INNXWARE)</h1>
                      <div className='div-modeloEducativo'>
                          <div className='div-modeloEducativo-izq col-7'>
                              <p><b>Objetivo:</b>Objetivo: Generar innovación y desarrollo en tecnologías de información con estándares internacionales, orientado a las necesidades del sector público y privado, particularmente en el desarrollo de software a la medida y gestión de servicios TI.</p>
